...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="nama_produk" id="nama_produk" class="mt-1 block w-full border border-gray-300 rounded-lg p-2 focus:ring focus:ring-green-200" required>
        </div>

        <div>
            <label for="biaya_produksi" class="block text-gray-700 font-medium">Biaya Produksi (Rp)</label>
            <input type="number" name="biaya_produksi" id="biaya_produksi" class="mt-1 block w-full border border-gray-300 rounded-lg p-2 focus:ring focus:ring-green-200" required>
        </div>
