    ...
    <table class="w-full table-auto text-sm min-w-[600px]">
        ...
        <tbody>
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="py-2 px-3">Sampoerna</td>
                <td class="py-2 px-3">17 Agustus 2025</td>
                <td class="py-2 px-3">70</td>
                <td class="py-2 px-3">Rp. 23.000.000</td>
                <td class="py-2 px-3">Rp. 30.000.000</td>
            </tr>
        </tbody>
    </table>
</div>
